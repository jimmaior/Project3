...
import com.sam_chordas.android.stockhawk.details.StockDetailActivity;
...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmptyListTV = (TextView) findViewById(R.id.tv_no_stock);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewItemClickListener(this,
                new RecyclerViewItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View v, int position) {
                        ...
                        String s = symbol.getText().toString();
                        symbol.setContentDescription(getString(R.string.a11y_symbol, s));
                        Log.d("TAB", "symbol = " + s);
                        intent.putExtra(EXTRA_SYMBOL, s);
